                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                            <div className="bg-white/5 rounded-xl p-3 border border-white/5">
                                <span className="text-[11px] text-white/40 block mb-1">Duration</span>
                                <div className="flex items-center gap-2 text-[13px] text-white/90">
                                    <Calendar size={13} className="text-macos-orange" />
                            ...
                            <div className="bg-white/5 rounded-xl p-3 border border-white/5">
                                ...
                                <div className="flex items-center gap-2 text-[13px] text-white/90">
                                    <MapPin size={13} className="text-macos-red" />
                                    {selectedExperience.location}
                                </div>
                            </div>
                            <div className="bg-white/5 rounded-xl p-3 border border-white/5">
                                <span className="text-[11px] text-white/40 block mb-1">Type</span>
                                <div className="flex items-center gap-2 text-[13px] text-white/90">
                                    <Globe size={13} className="text-macos-teal" />
